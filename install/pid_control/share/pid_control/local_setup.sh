...
: ${AMENT_CURRENT_PREFIX:="/home/saun/ctrl_mr_dynamic/install/pid_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pid_control/environment/pythonpath.sh"
